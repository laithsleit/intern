...
import PlayerRebort from '../Dashboard/PlayerRebort'

export default function DashbordRes() {
  return (
    <>
            <div>
      {/* Sidebar */}
      ...
      <h3 style={{fontSize:"20px" ,textAlign:"center",paddingBottom:"em", fontFamily:"sans-serif"}} className="w3-bar-item">Dashbord Magic Media</h3>
        <Link style={{fontSize:"30px" , fontFamily:"sans-serif"}} to="./" className="w3-bar-item w3-button">Home Page</Link>
        <Link style={{fontSize:"30px" , fontFamily:"sans-serif"}} to="./DashbordUser" className="w3-bar-item w3-button">Users</Link>
        <Link style={{fontSize:"30px" , fontFamily:"sans-serif"}} to="./DashbordRebot" className="w3-bar-item w3-button">Rebort</Link>
      </div>
